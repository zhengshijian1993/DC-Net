...
def draw_3D(lut, title=None, point_size=20, time=2): # lut: (1,d,d,d)  OR  (3,d,d,d)
    fullscreen()
    if len(lut.shape) == 5:
        lut = lut.squeeze()
...
if __name__ == "__main__":
    ...
    root = "/home/zlh/data/zsj/1.DCNet/cankao/3DLUT/CLUT-Net-main/FiveK"
    name = "20+05+20_models/"
    epoch = 365
